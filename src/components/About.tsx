    ...
    <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-4">
          <img src="/images/1.png" className="rounded-sm grayscale-scroll transition-all" alt="Técnico 1" referrerPolicy="no-referrer" />
        ...
        <div className="space-y-4">
          <img src="/images/2.png" className="rounded-sm grayscale-scroll transition-all" alt="Técnico 2" referrerPolicy="no-referrer" />
          <div className="bg-industrial-navy p-4 text-white">
        ...
        <div className="space-y-4">
          <img src="/images/3.png" className="rounded-sm grayscale-scroll transition-all" alt="Técnico 3" referrerPolicy="no-referrer" />
          <div className="bg-industrial-navy p-4 text-white">
        ...
        <div className="space-y-4">
          <img src="/images/4.png" className="rounded-sm grayscale-scroll transition-all" alt="Técnico 4" referrerPolicy="no-referrer" />
          <div className="bg-industrial-navy p-4 text-white">
